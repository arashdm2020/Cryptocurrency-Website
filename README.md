...
```bash
sudo git clone https://github.com/arashdm2020/Cryptocurrency-Website.git
```

Windows:

```bash
git clone https://github.com/arashdm2020/Cryptocurrency-Website.git
```

### Contact

If you want to contact with me you can reach me at 
[Twitter](https://www.twitter.com/black_spid3r9)
Or
[Telegram](https://t.me/Blackspid3r9)
